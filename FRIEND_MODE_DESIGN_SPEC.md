...
| F21 | `fmPaceAsk` | How often do you want {Crew} nights? Reply a number of weeks (2, 4, 6 or 8). Say nothing and it's every {n} weeks, like the crew. (Once, right after joining; a bare number in the next 24h answers it unless a poll is open.) |
| F22 | `fmPaceSet` | Got it: {Crew} about every {n} weeks for you. Change it anytime with EVERY 4, EVERY 8, and so on. |
