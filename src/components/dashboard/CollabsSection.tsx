...
//                RSVPs it brought in
//   Partnerships who we auto-accept from, and who auto-accepts from us
//   Settings     per-calendar "accept share requests" switch
...
export default function CollabsSection({
  ...
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      {/* Partnerships + settings, per calendar */}
      <section className="border border-zinc-200 rounded-xl overflow-hidden">
        <div className="px-4 py-3 border-b border-zinc-100">
          <h4 className="text-[11px] font-semibold tracking-[0.12em] uppercase text-zinc-500">Partnerships &amp; settings</h4>
        </div>
        <ul>
