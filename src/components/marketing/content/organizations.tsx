...
// /organizations — content only. Structure lives in MarketingPage.
// FAQ is the page's own existing copy, reused verbatim per the spec.

export const organizationsContent: MarketingContent = {
  hero: {
    headline: (
      <>
        Type a vibe.
  ...
  toolkitHeading: "Built for real community building",
  toolkit: [
    {
  ...
  pricing: {
    ...
    tiers: [
      ...
      },
      {
        ...
        description:
          "For organizers who want their own brand and room to grow",
        cta: "Go Pro →",
        highlight: true,
  ...
  footerBlurb:
    "AI-powered community calendars for the organizations that bring people together.",
};
