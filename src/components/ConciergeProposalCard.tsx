          ...
          <>
            ...
            {askChanges ? (
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                ...
                <button onClick={() => setEditing(true)} disabled={!!busy} className="inline-flex items-center gap-1 text-xs font-medium text-zinc-500 hover:text-zinc-900 disabled:opacity-50">
                  <Pencil className="w-3.5 h-3.5" /> Edit
                </button>
                <button onClick={() => setAskChanges(true)} disabled={!!busy} className="text-xs font-medium text-zinc-500 hover:text-zinc-900 disabled:opacity-50">
                  Request changes
                </button>
                <button onClick={extend} disabled={!!busy} className="ml-auto text-xs font-medium text-zinc-400 hover:text-zinc-700 disabled:opacity-50">
                  {busy === "extend" ? "…" : "Extend"}
                </button>
              </div>
            )}
