...
export const metadata: Metadata = {
  ...
  description:
    "Get your business in front of the residents who live minutes from your door — through their building's community calendar, or an event we fill for you. Feature a deal or host an event.",
  openGraph: {
    title: "Leaf OS — Your next regulars live around the corner",
    description:
      "Reach nearby residents inside the community they trust. Feature a deal or host an event — we bring the people.",
    type: "website",
  },
