...
export default function OrgDashboardPage() {
  ...
  // The Stripe return handler for the AI-assisted host purchase lived here.
  // Removed 2026-09-02 — the virtual host is no longer for sale, and
  // getVirtualHostAttachStatus is deleted server-side.
