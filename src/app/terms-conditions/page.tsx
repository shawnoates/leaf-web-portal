...
export const metadata: Metadata = {
  title: "Terms and Conditions — Leaf",
  description: "Terms governing your use of Leaf.",
};
    ...
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <main className="max-w-3xl mx-auto px-6 py-20">
        <div className="space-y-3 mb-16">
          ...
          <p className="text-sm text-zinc-500">Last updated: February 25, 2021</p>
        </div>
        ...
        <article className="space-y-12 text-zinc-700 leading-relaxed font-light">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-3">
              ...
              <li>
                <strong className="font-medium text-zinc-900">Application Store</strong>{" "}
              ...
              <li>
                ...
                Leaf, 423 E. 82nd St. #3B, New York, NY 10028.
              </li>
              <li>
                <strong className="font-medium text-zinc-900">Content</strong>{" "}
              ...
              <li>
                <strong className="font-medium text-zinc-900">Feedback</strong>{" "}
                means feedback, innovations or suggestions sent by You regarding
                the attributes, performance or features of our Service.
              </li>
              <li>
                <strong className="font-medium text-zinc-900">Free Trial</strong>{" "}
                refers to a limited period of time that may be free when
                purchasing a Subscription.
              </li>
              <li>
                <strong className="font-medium text-zinc-900">In-app Purchase</strong>{" "}
                refers to the purchase of a product, item, service or
                Subscription made through the Application and subject to these
                Terms and Conditions and/or the Application Store&apos;s own
                terms and conditions.
              </li>
              <li>
                <strong className="font-medium text-zinc-900">Promotions</strong>{" "}
              ...
              <li>
                <strong className="font-medium text-zinc-900">Subscriptions</strong>{" "}
              ...
              <li>
                ...
                (also referred as &ldquo;Terms&rdquo;) mean these Terms and
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-normal text-zinc-900">Acknowledgment</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-normal text-zinc-900">Subscriptions</h2>
            ...
            <h3 className="text-base font-medium text-zinc-900">Billing</h3>
            <p>
            ...
            <h3 className="text-base font-medium text-zinc-900">Fee Changes</h3>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-normal text-zinc-900">Free Trial</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-normal text-zinc-900">In-app Purchases</h2>
            <p>
            ...
            <p>
              ...
              unlikely event that we are unable to replace or repair the relevant
              In-app Purchase or are unable to do so within a reasonable period
              of time and without significant inconvenience to You, We will
              authorize the Application Store to refund You an amount up to the
              cost of the relevant In-app Purchase. Alternatively, if You wish to
              request a refund, You may do so by contacting the Application Store
              directly.
            </p>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-normal text-zinc-900">Promotions</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-normal text-zinc-900">User Accounts</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-normal text-zinc-900">Content</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-normal text-zinc-900">Copyright Policy</h2>
            ...
            <p>
              ...
              the Service, You must submit Your notice in writing to the
              attention of our copyright agent via email at{" "}
              <a
                href="mailto:copyright@getleaflets.co"
                className="underline hover:text-zinc-900"
              >
                copyright@getleaflets.co
              </a>{" "}
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-normal text-zinc-900">Termination</h2>
            <p>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              Service; or (iv) that the Service, its servers, the content, or
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-normal text-zinc-900">Governing Law</h2>
            <p>
          ...
          <section className="space-y-4">
            ...
            <h3 className="text-base font-medium text-zinc-900">Severability</h3>
            <p>
            ...
            <h3 className="text-base font-medium text-zinc-900">Waiver</h3>
            <p>
          ...
          <section className="space-y-4">
            ...
            <p>
              By email:{" "}
              <a
                href="mailto:terms@getleaflets.co"
                className="underline hover:text-zinc-900"
              >
                terms@getleaflets.co
              </a>
            </p>
          </section>
        </article>
